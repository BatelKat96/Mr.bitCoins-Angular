...
// import { Pet, PetFilter } from '../models/pet.model';
...
//     private _petFilter$ = new BehaviorSubject<PetFilter>({ term: '' });
...
//     public setFilter(petFilter: PetFilter) {
